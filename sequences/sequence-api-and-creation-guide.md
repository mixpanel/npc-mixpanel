...
```json
{
  "my-funnel": {
    ...
    "actions": [
      ...
      { "action": "click", "selector": "#submit", "requireActive": true }
    ]
  }
}
```
...
|---|---|---|---|
| `click` | `selector` | `requireActive` | Click an element. Adds natural mouse movement + position fuzz. |
...
This is useful when a button only activates after form validation passes.
...
| Circuit breaker | 3 consecutive failures stops the sequence |
